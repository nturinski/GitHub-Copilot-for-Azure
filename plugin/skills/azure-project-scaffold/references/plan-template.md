...
> Auto-generated by Step 0 into `.azure/execution-checklist.md` + expanded with build gates.

- [ ] 1: Foundation
- [ ] 2: Config & Env
- [ ] 3: Service Abstraction (interfaces + impls + registry)
- [ ] 4: DB Schema & Migrations (if applicable)
- [ ] 5: Shared Types & Validation
- [ ] 6: API Routes / Functions
- [ ] 7: Error Handling Middleware
- [ ] 8: Health Check
- [ ] 9: OpenAPI Contract
- [ ] 10: Structured Logging
- [ ] 11: Wire Frontend (if applicable)
- [ ] 12: Wrap Up
...
2. `azure-project-verify` — test coverage
3. `azure-localdev` — Docker emulators + IDE debugger
4. `azure-prepare` → `azure-deploy` when ready
````
